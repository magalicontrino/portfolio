...
/* Outils dev ajoutes a la demande (Claude Code, OpenCode, GitHub, Supabase) :
   logos monochromes officiels, meme gabarit que la rangee existante. La rangee
   passe a la ligne, sinon huit logos deborderaient sur mobile. */
.div-block-213 { flex-wrap: wrap; }
.image-121.outil { width: 46px; }
